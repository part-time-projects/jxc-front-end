<template>
  <a-card :bordered="false">
    ...
    <rubric-pur-in-bill-modal ref="modalForm" @ok="modalFormOk"></rubric-pur-in-bill-modal>
  </a-card>
</template>
...
<script>
  ...
  import RubricPurInBillModal from './modules/RubricPurInBillModal'
  ...
  export default {
    name: "RubricPurInBillList",
    mixins:[JeecgListMixin, billListMixin],
    components: {
      JDate,
      JSelectUserByDep,
      ListColumnsSetter,
      RubricPurInBillModal
    },
    ...
    data () {
      return {
        ...
        url: {
          list: "/stock/stkIoBill/list/101/1",
          delete: "/stock/stkIoBill/delete",
          deleteBatch: "/stock/stkIoBill/deleteBatch",
          exportXlsUrl: "/stock/stkIoBill/exportXls/101/1",
