<template>
  <a-card :bordered="false">
    ...
    <rubric-sal-out-bill-modal ref="modalForm" @ok="modalFormOk"></rubric-sal-out-bill-modal>
  </a-card>
</template>
...
<script>
  ...
  import RubricSalOutBillModal from './modules/RubricSalOutBillModal'
  import JDate from '@/components/jeecg/JDate.vue'
  import ListColumnsSetter from '../components/ListColumnsSetter'
  import { billListMixin } from '../mixins/billListMixin'

  export default {
    name: "RubricSalOutBillList",
    mixins:[JeecgListMixin, billListMixin],
    components: {
      JDate,
      JSelectUserByDep,
      ListColumnsSetter,
      RubricSalOutBillModal
    },
    ...
    data () {
      return {
        ...
        url: {
          list: "/stock/stkIoBill/list/201/1",
          delete: "/stock/stkIoBill/delete",
          deleteBatch: "/stock/stkIoBill/deleteBatch",
          exportXlsUrl: "/stock/stkIoBill/exportXls/201/1",
