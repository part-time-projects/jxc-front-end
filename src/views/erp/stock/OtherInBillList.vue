<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
            <a-col :md="6" :sm="24">
              ...
              <j-super-query v-if="toggleSearchStatus" style="margin-left: 16px" :fieldList="fieldList" ref="superQueryModal" @handleSuperQuery="handleSuperQuery"></j-super-query>
    ...
    <other-in-bill-modal ref="modalForm" @ok="modalFormOk"></other-in-bill-modal>
  </a-card>
</template>
...
<script>
  ...
  import OtherInBillModal from './modules/OtherInBillModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/stock/stkIoBill/list/199",
          delete: "/stock/stkIoBill/delete",
          deleteBatch: "/stock/stkIoBill/deleteBatch",
          exportXlsUrl: "/stock/stkIoBill/exportXls/199",
