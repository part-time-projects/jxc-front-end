<template>
  <a-card :bordered="false">
    ...
    <change-cost-bill-modal ref="modalForm" @ok="modalFormOk"></change-cost-bill-modal>
  </a-card>
</template>
...
<script>
  ...
  import ChangeCostBillModal from './modules/ChangeCostBillModal'
  import JDate from '@/components/jeecg/JDate.vue'
  import ListColumnsSetter from '../components/ListColumnsSetter'
  import { billListMixin } from '../mixins/billListMixin'

  export default {
    name: "ChangeCostBillList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/stock/stkIoBill/list/801",
          delete: "/stock/stkIoBill/delete",
          deleteBatch: "/stock/stkIoBill/deleteBatch",
          exportXlsUrl: "/stock/stkIoBill/exportXls/801",
