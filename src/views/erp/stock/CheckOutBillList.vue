<template>
  <a-card :bordered="false">
    ...
    <check-out-bill-modal ref="modalForm" @ok="modalFormOk"></check-out-bill-modal>
  </a-card>
</template>
...
<script>
  ...
  import CheckOutBillModal from './modules/CheckOutBillModal'
  import JDate from '@/components/jeecg/JDate.vue'
  import ListColumnsSetter from '../components/ListColumnsSetter'
  import { billListMixin } from '../mixins/billListMixin'

    export default {
    name: "CheckOutBillList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/stock/stkIoBill/list/202",
          delete: "/stock/stkIoBill/delete",
          deleteBatch: "/stock/stkIoBill/deleteBatch",
          exportXlsUrl: "/stock/stkIoBill/exportXls/202",
