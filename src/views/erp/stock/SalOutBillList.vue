<template>
  <a-card :bordered="false">
    ...
    <sal-out-bill-modal ref="modalForm" @ok="modalFormOk"></sal-out-bill-modal>
  </a-card>
</template>
...
<script>
  ...
  import SalOutBillModal from './modules/SalOutBillModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/stock/stkIoBill/list/201/0",
          delete: "/stock/stkIoBill/delete",
          deleteBatch: "/stock/stkIoBill/deleteBatch",
          exportXlsUrl: "/stock/stkIoBill/exportXls/201/0",
