<template>
  <a-card :bordered="false">
    ...
    <swell-in-bill-modal ref="modalForm" @ok="modalFormOk"></swell-in-bill-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/stock/stkIoBill/list/191",
          delete: "/stock/stkIoBill/delete",
          deleteBatch: "/stock/stkIoBill/deleteBatch",
          exportXlsUrl: "/stock/stkIoBill/exportXls/191",
