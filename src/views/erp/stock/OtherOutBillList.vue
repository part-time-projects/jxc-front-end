<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="客户">
                <j-dict-select-tag v-model="queryParam.customerId" dictCode="bas_customer,name,id"/>
              </a-form-item>
            </a-col>
    ...
    <other-out-bill-modal ref="modalForm" @ok="modalFormOk"></other-out-bill-modal>
  </a-card>
</template>
...
<script>
  ...
  import OtherOutBillModal from './modules/OtherOutBillModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/stock/stkIoBill/list/299",
          delete: "/stock/stkIoBill/delete",
          deleteBatch: "/stock/stkIoBill/deleteBatch",
          exportXlsUrl: "/stock/stkIoBill/exportXls/299",
