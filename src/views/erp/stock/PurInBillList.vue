<template>
  <a-card :bordered="false">
    ...
    <purInBill-modal ref="modalForm" @ok="modalFormOk"></purInBill-modal>
  </a-card>
</template>
...
<script>
  ...
  import PurInBillModal from './modules/PurInBillModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/stock/stkIoBill/list/101/0",
          delete: "/stock/stkIoBill/delete",
          deleteBatch: "/stock/stkIoBill/deleteBatch",
          exportXlsUrl: "/stock/stkIoBill/exportXls/101/0",
