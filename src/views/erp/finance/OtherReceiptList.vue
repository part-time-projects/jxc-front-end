<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="4" :lg="6" :md="7" :sm="24">
              <a-form-item label="是否作废">
                <j-dict-select-tag placeholder="请选择是否作废" v-model="queryParam.isVoided" dictCode="yn"/>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <!--      <a-button type="link" icon="download" @click="handleExportXls('其他付款单')">导出</a-button>
    ...
    <other-receipt-modal ref="modalForm" @ok="modalFormOk"></other-receipt-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/finance/finReceipt/list/199",
          delete: "/finance/finReceipt/delete",
          deleteBatch: "/finance/finReceipt/deleteBatch",
          exportXlsUrl: "/finance/finReceipt/exportXls/199",
          importExcelUrl: "finance/finReceipt/importExcel",
        },
        dictOptions:{},
      }
    },
