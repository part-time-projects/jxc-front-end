<template>
  <a-card :bordered="false">
    ...
    <pur-payable-modal ref="modalForm" @ok="modalFormOk"></pur-payable-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/finance/finPayable/list/202",
          delete: "/finance/finPayable/delete",
          deleteBatch: "/finance/finPayable/deleteBatch",
          exportXlsUrl: "/finance/finPayable/exportXls/202",
          importExcelUrl: "finance/finPayable/importExcel",
        },
        dictOptions:{},
      }
    },
