<template>
  <a-card :bordered="false">
    ...
    <pur-prepayment-modal ref="modalForm" @ok="modalFormOk"></pur-prepayment-modal>
  </a-card>
</template>
...
<script>
  ...
  import PurPrepaymentModal from "./modules/PurPrepaymentModal";
  import ListColumnsSetter from '../components/ListColumnsSetter'
  import { billListMixin } from '../mixins/billListMixin'

  export default {
    name: "PurPrepaymentList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/finance/finPayment/list/201",
          delete: "/finance/finPayment/delete",
          deleteBatch: "/finance/finPayment/deleteBatch",
          exportXlsUrl: "/finance/finPayment/exportXls/201",
          importExcelUrl: "finance/finPayment/importExcel",
        },
        dictOptions:{},
      }
    },
