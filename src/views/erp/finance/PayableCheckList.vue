<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <!--      <a-button type="link" icon="download" @click="handleExportXls('应付核销单')">导出</a-button>
    ...
    <PayableCheck-modal ref="modalForm" @ok="modalFormOk"></PayableCheck-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/finance/finPayableCheck/list/201",
          delete: "/finance/finPayableCheck/delete",
          deleteBatch: "/finance/finPayableCheck/deleteBatch",
          exportXlsUrl: "/finance/finPayableCheck/exportXls/201",
          importExcelUrl: "/finance/finPayableCheck/importExcel",
        },
        dictOptions:{},
      }
    },
