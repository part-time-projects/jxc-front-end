<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="5" :lg="7" :md="8" :sm="24">
            <a-form-item label="客户">
              <j-dict-select-tag placeholder="请选择客户" v-model="queryParam.customerId" dictCode="bas_customer,name,id"/>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :xl="4" :lg="6" :md="7" :sm="24">
              <a-form-item label="处理状态">
                <j-dict-select-tag placeholder="请选择处理状态" v-model="queryParam.billProcStatus" dictCode="x_bill_proc_status"/>
              </a-form-item>
            </a-col>
            <a-col :xl="4" :lg="6" :md="7" :sm="24">
              <a-form-item label="是否通过">
                <j-dict-select-tag placeholder="请选择是否通过" v-model="queryParam.isApproved" dictCode="yn"/>
              </a-form-item>
            </a-col>
            <a-col :xl="4" :lg="6" :md="7" :sm="24">
    ...
    <div class="table-operator">
      ...
      <!--      <a-button type="link" icon="download" @click="handleExportXls('往来核销单')">导出</a-button>
    ...
    <receivable-check-modal ref="modalForm" @ok="modalFormOk"></receivable-check-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/finance/finReceivableCheck/list/101",
          delete: "/finance/finReceivableCheck/delete",
          deleteBatch: "/finance/finReceivableCheck/deleteBatch",
          exportXlsUrl: "/finance/finReceivableCheck/exportXls/101",
          importExcelUrl: "/finance/finReceivableCheck/importExcel",
        },
        dictOptions:{},
      }
    },
