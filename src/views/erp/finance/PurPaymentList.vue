<template>
  <a-card :bordered="false">
    ...
    <pur-payment-modal ref="modalForm" @ok="modalFormOk"></pur-payment-modal>
  </a-card>
</template>
...
<script>
  ...
  import PurPaymentModal from './modules/PurPaymentModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/finance/finPayment/list/202",
          delete: "/finance/finPayment/delete",
          deleteBatch: "/finance/finPayment/deleteBatch",
          exportXlsUrl: "/finance/finPayment/exportXls/202",
