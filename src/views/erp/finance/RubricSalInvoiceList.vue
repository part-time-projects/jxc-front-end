<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="客户">
                <j-dict-select-tag v-model="queryParam.customerId" dictCode="bas_customer,name,id" placeholder="请选择客户"/>
              </a-form-item>
            </a-col>
    ...
    <RubricSalInvoice-modal ref="modalForm" @ok="modalFormOk"></RubricSalInvoice-modal>
  </a-card>
</template>
...
<script>
  ...
  import RubricSalInvoiceModal from './modules/RubricSalInvoiceModal'
  ...
  export default {
    ...
    components: {
      ...
      JSelectUserByDep,
      ListColumnsSetter,
      RubricSalInvoiceModal
    },

    data () {
      return {
        description: '销售发票（红字）登记',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/finance/finSalInvoice/list/1",
          delete: "/finance/finSalInvoice/delete",
          deleteBatch: "/finance/finSalInvoice/deleteBatch",
          exportXlsUrl: "/finance/finSalInvoice/exportXls/1",
          importExcelUrl: "finance/finSalInvoice/importExcel",
        },
        dictOptions:{},
      }
    },
