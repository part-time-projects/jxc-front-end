          ...
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="业务员">
                <j-select-user-by-dep v-model="queryParam.clerkId"></j-select-user-by-dep>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="供应商">
                <j-dict-select-tag v-model="queryParam.supplierId" dictCode="bas_supplier,name,id" placeholder="请选择供应商"/>
              </a-form-item>
            </a-col>
...
-->
    ...
    <div>
      <a-table
        ...
        <a-icon slot="filterIcon" type='setting' :style="{ fontSize:'14px', color: '#108ee9', marginRight: '12px' }" />
    ...
    <RubricPurInvoice-modal ref="modalForm" @ok="modalFormOk"></RubricPurInvoice-modal>
  </a-card>
</template>

<script>
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import RubricPurInvoiceModal from './modules/RubricPurInvoiceModal'
  ...
  export default {
    ...
    components: {
      ...
      JSelectUserByDep,
      ListColumnsSetter,
      RubricPurInvoiceModal
    },

    data () {
      return {
        description: '采购发票（红字）登记',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/finance/finPurInvoice/list/1",
          delete: "/finance/finPurInvoice/delete",
          deleteBatch: "/finance/finPurInvoice/deleteBatch",
          exportXlsUrl: "/finance/finPurInvoice/exportXls/1",
          importExcelUrl: "finance/finPurInvoice/importExcel",
        },
        dictOptions:{},
      }
    },
