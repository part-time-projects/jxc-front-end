<template>
  <a-card :bordered="false">
    ...
    <other-payment-modal ref="modalForm" @ok="modalFormOk"></other-payment-modal>
  </a-card>
</template>
...
<script>
  ...
  import OtherPaymentModal from "./modules/OtherPaymentModal";
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/finance/finPayment/list/299",
          delete: "/finance/finPayment/delete",
          deleteBatch: "/finance/finPayment/deleteBatch",
          exportXlsUrl: "/finance/finPayment/exportXls/299",
