  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-dropdown v-if="selectedRowKeys.length > 0">
        <a-menu slot="overlay">
          <a-menu-item disabled="true" key="1" @click=""><a-icon type="delete"/>关闭</a-menu-item>
        </a-menu>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/finance/finReceivable/list/102",
          delete: "/finance/finReceivable/delete",
          deleteBatch: "/finance/finReceivable/deleteBatch",
          exportXlsUrl: "/finance/finReceivable/exportXls/102",
          importExcelUrl: "finance/finReceivable/importExcel",
        },
        dictOptions:{},
      }
    },
